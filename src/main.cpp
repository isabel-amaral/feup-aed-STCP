...
int main() {
    ...
    buses.setWalkingDistance(150);
    lines.setWalkingDistance(150);
    ...
    //lines.getShortestPathWithinSameLine(41.1792000,-8.598682200, 41.38714064, -8.75989474);

    //buses.getShortestPathChangingLines(41.15404794,-8.673866668, 41.17883946,-8.598663762);
    
    //buses.getMinimumStopsPath(41.17986835,-8.588496841, 41.18221828,-8.596427581); // start= enx2, end = asp4;//caso1
    //buses.getMinimumStopsPath(41.17672431,-8.620723124, 41.17883946,-8.598663762); // start = bra4, end = feup1// caso2
    //buses.getMinimumStopsPath(41.22070233,-8.713217906, 41.23691113,-8.670278173); //CBNM2 - AEPT1 (aeroporto)// caso3
    ...
    //buses.getMinimumStopsPath(41.17975194,-8.628611164,41.17190078,-8.616842818);  //mst3-mtb3 // caso4
    //buses.getMinimumStopsPath(41.17933489,-8.651703915, 41.18221828,-8.596427581); //ruela-asprela4 //caso5 - 110m
