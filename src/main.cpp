...
int main() {
    ...
    //buses.getMinimumStopsPath(41.17975194,-8.628611164,41.17190078,-8.61684281);  //mst3-mtb3
    //buses.getMinimumStopsPath(41.17933489,-8.651703915, 41.18221828,-8.59642758); //ruela-asprela4
